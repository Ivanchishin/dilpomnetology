    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'New'), ('confirmed', 'Confirmed'), ('shipped', 'Shipped'), ('done', 'Done')], default='new', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='infos', to='core.product')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameters', to='core.productinfo')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_info', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.productinfo')),
            ],
        ),
        migrations.CreateModel(
            name='BasketItem',
